			...
			case ID_ABOUT:
				{
					...
					{
						MessageBox(hwnd, L"Dialog failure!", L"Error", MB_OK | MB_ICONEXCLAMATION);
					}
				}
				break;
			case ID_FILE_EX:
...
int WINAPI WinMain5(HINSTANCE hInst, HINSTANCE hPrevInst, LPSTR lpCmdLine, int nCmdToShow)
{
	WNDCLASSEX wex = {0};
	HWND hwnd;
	MSG msg;
